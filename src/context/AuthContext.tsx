...
export const ROLE_PERMISSIONS: Record<UserRole, string[] | 'all'> = {
  Admin: 'all',
  Cashier: ['dashboard', 'profile', 'help', 'students', 'cashier', 'cashbook', 'payments', 'classfees', 'lunch', 'bulkfees', 'expenses', 'statements', 'uniforms', 'library', 'debtors', 'transport', 'fundraisers', 'kitchen', 'feestructure', 'reports', 'templates', 'gallery', 'messaging', 'tools'],
  Teacher: ['dashboard', 'profile', 'help', 'students', 'classes', 'attendance', 'results', 'subjects', 'worksheets', 'timetable', 'calendar', 'events', 'announcements', 'requirements', 'library', 'reports', 'gallery', 'tools'],
