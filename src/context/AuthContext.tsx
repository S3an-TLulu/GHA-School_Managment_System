...
export const ROLE_PERMISSIONS: Record<UserRole, string[] | 'all'> = {
  Admin: 'all',
  Cashier: ['dashboard', 'profile', 'help', 'students', 'cashier', 'cashbook', 'payments', 'lunch', 'bulkfees', 'expenses', 'statements', 'uniforms', 'library', 'debtors', 'transport', 'fundraisers', 'kitchen', 'feestructure', 'reports', 'templates', 'gallery', 'messaging', 'tools'],
