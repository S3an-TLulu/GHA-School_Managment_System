...
export const ROLE_PERMISSIONS: Record<UserRole, string[] | 'all'> = {
  ...
  Teacher: ['dashboard', 'profile', 'help', 'students', 'classes', 'attendance', 'results', 'subjects', 'timetable', 'calendar', 'events', 'announcements', 'requirements', 'library', 'reports', 'gallery', 'tools'],
